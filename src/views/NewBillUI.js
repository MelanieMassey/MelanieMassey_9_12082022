            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <p class="file-error hidden" data-testid="file-error">Le format du fichier est invalide. Formats acceptés : .jpg, .jpeg ou .png</p>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' class="btn btn-primary" data-testid="submitNewBill">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
